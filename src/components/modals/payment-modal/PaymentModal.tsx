	...
	return (
		<div className='fixed inset-0 z-120 flex items-center justify-center'>
			...
			<div className='relative z-10 max-w-400 w-full m-0 md:m-5 max-h-[96vh] h-full rounded-[10px] overflow-hidden flex flex-col bg-background border border-border'>
				...
				<div
					className={cn(
						"absolute inset-0 z-0 bg-[url('/background/anomaly-img-bg-modal.jpg')] bg-cover bg-center",
				...
				<div className='relative z-10 flex justify-end p-4 animate-contentIn'>
					<button
						onClick={closeModal}
				...
				{/* SCROLL AREA */}
				<div className='relative z-10 flex-1 overflow-y-auto px-5 xs:px-8 pb-10 animate-contentIn'>
					<div className='flex flex-col items-center md:items-start lg:flex-row gap-5 xs:gap-7.5 lg:justify-between max-w-270 mx-auto'>
						...
						<div className='flex flex-col items-center md:items-start max-w-150 w-full space-y-4 xs:space-y-5 text-center md:text-left'>
							...
							<p
								className={cn(
									text.bodyLarge,
									'max-w-75.5 xs:max-w-105 md:max-w-87.5'
								)}
							>
